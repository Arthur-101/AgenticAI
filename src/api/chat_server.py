...
async def startup_event():
    """Initialize chat router on startup."""
    global chat_router
    try:
        chat_router = ChatRouter()
        await chat_router.initialize_client()
        print("AgenticAI Chat API started successfully")
...
async def health_check() -> Dict[str, Any]:
    ...
    global chat_router
    status = "healthy" if chat_router else "uninitialized"
    return {
        "status": status,
